...
AH-T01A also fixes the deployment and rollback target set at exactly `api` + `renderer`. Worker,
Agent Hub and Redis container/image identities are immutable, while queue/processing,
