...
def parse_envelope(value, *, require_preflight=True):
    ...
    require(OPERATION != 'UNBOUND' and envelope.get('schema') == DISPATCH_SCHEMA, 'FRESH_PROFILE_UNBOUND_OR_SCHEMA_INVALID')
    try: validate_fresh_operation_id(OPERATION)
