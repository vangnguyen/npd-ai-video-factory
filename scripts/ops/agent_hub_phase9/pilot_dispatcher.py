...
from gate_bindings import GateStop, fresh, require, sha, verify_package
...
def verify_execution_approval(approval, verified, expected_manifest, *, current=None, phase='mutation'):
    ...
    try:
        ...
        require(phase in {'mutation', 'decision', 'recovery'}, 'EXECUTION_PHASE_INVALID')
        limit = times[{'mutation': 1, 'decision': 2, 'recovery': 3}[phase]]
