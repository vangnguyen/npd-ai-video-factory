...
class Phase9SalesShadowEvaluationService:
    """Aggregate-only Phase 9B evaluation over signed Sales SLA, score v2 and NBA v2."""
    ...
    def evaluate(
        ...
        caveats = [
            ...
            "Phase 9B recommendation review telemetry is not yet connected; existing Phase 9A review aggregates are intentionally not mixed into this report.",
        ]
